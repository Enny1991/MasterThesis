...
loss_all_m = lasagne.objectives.squared_error(output_m * x_sym, m_sym) - 0.5 * lasagne.objectives.squared_error(output_m * x_sym, f_sym)
loss_all_f = lasagne.objectives.squared_error(output_f * x_sym, f_sym) - 0.5 * lasagne.objectives.squared_error(output_f * x_sym, m_sym)
