...
if __name__ == "__main__":
    ...
    train_m = loadmat('../../../data/PCA/GRID Corpus/12kHz/stacked_GRID_{}.mat'.format(index_timit))['SPTa']
    train_f = loadmat('../../../data/PCA/GRID Corpus/12kHz/stacked_GRID_{}.mat'.format(index_timit))['SPTb']
    train_x = loadmat('../../../data/PCA/GRID Corpus/12kHz/stacked_GRID_{}.mat'.format(index_timit))['SPT']
    test_m = loadmat('../../../data/PCA/GRID Corpus/12kHz/stacked_GRID_{}.mat'.format(index_timit))['SPTatest']
    test_f = loadmat('../../../data/PCA/GRID Corpus/12kHz/stacked_GRID_{}.mat'.format(index_timit))['SPTbtest']
    test_x = loadmat('../../../data/PCA/GRID Corpus/12kHz/stacked_GRID_{}.mat'.format(index_timit))['SPTtest']
    ...
    if tpe is 0:
        if normalize is 1:
            savemat('results/stacked_mse_GRID_{}_N.mat'.format(index_timit), {'out_out_m': out_out_m,
                                                               'out_out_f': out_out_f,
                                                               'mmm': mmm})
        else:
            savemat('results/stacked_mse_GRID_{}.mat'.format(index_timit), {'out_out_m': out_out_m, 'out_out_f': out_out_f})
        pkl.dump(lasagne.layers.get_all_param_values([l_out_m]),
                 open('models/stacked_mse_GRID_m_{}_{}_{}'.format(date, NUM_UNITS_ENC, index_timit), 'wb'))
        pkl.dump(lasagne.layers.get_all_param_values([l_out_f]),
                 open('models/stacked_mse_GRID_f_{}_{}_{}'.format(date, NUM_UNITS_ENC, index_timit), 'wb'))
    if tpe is 1:
        if normalize is 1:
            savemat('results/stacked_one_minus_GRID_{}_N.mat'.format(index_timit), {'out_out_m': out_out_m,
                                                                     'mmm': mmm})
        else:
            savemat('results/stacked_one_minus_GRID_{}.mat'.format(index_timit), {'out_out_m': out_out_m})
        pkl.dump(lasagne.layers.get_all_param_values([l_out_m]),
                 open('models/stacked_one_minus_GRID_m_{}_{}_{}'.format(date, NUM_UNITS_ENC, index_timit), 'wb'))
        pkl.dump(lasagne.layers.get_all_param_values([l_out_f]),
                 open('models/stacked_one_minus_GRID_f_{}_{}_{}'.format(date, NUM_UNITS_ENC, index_timit), 'wb'))
    if tpe is 2:
        if normalize is 1:
            savemat('results/stacked_force_SIR_GRID_{}_N.mat'.format(index_timit), {'out_out_m': out_out_m,
                                                               'out_out_f': out_out_f,
                                                               'mmm': mmm})
        else:
            savemat('results/stacked_force_SIR_GRID_{}.mat'.format(index_timit), {'out_out_m': out_out_m, 'out_out_f': out_out_f})
        pkl.dump(lasagne.layers.get_all_param_values([l_out_m]),
                 open('models/stacked_force_SIR_GRID_m_{}_{}_{}'.format(date, NUM_UNITS_ENC, index_timit), 'wb'))
        pkl.dump(lasagne.layers.get_all_param_values([l_out_f]),
                 open('models/stacked_force_SIR_GRID_f_{}_{}_{}'.format(date, NUM_UNITS_ENC, index_timit), 'wb'))
