...
if __name__ == "__main__":
    ...
    train_m = loadmat('data/100_classic_timit_{}.mat'.format(index_timit))['PWRa']
    train_f = loadmat('data/100_classic_timit_{}.mat'.format(index_timit))['PWRb']
    train_x = loadmat('data/100_classic_timit_{}.mat'.format(index_timit))['PWR']
    test_m = loadmat('data/100_classic_timit_{}.mat'.format(index_timit))['PWRatest']
    test_f = loadmat('data/100_classic_timit_{}.mat'.format(index_timit))['PWRbtest']
    test_x = loadmat('data/100_classic_timit_{}.mat'.format(index_timit))['PWRtest']
    ...
    if tpe is 0:
        if normalize is 1:
            savemat('results/100_mse_timit_{}_N_direct.mat'.format(index_timit), {'out_out_m': out_out_m,
                                                               'out_out_f': out_out_f,
                                                               'mmm': mmm})
        else:
            savemat('results/100_mse_timit_{}_direct.mat'.format(index_timit), {'out_out_m': out_out_m, 'out_out_f': out_out_f})
        pkl.dump(lasagne.layers.get_all_param_values([l_decoder_m]),
                 open('models/100_mse_timit_m_{}_{}_{}_direct'.format(date, NUM_UNITS_ENC, index_timit), 'wb'))
        pkl.dump(lasagne.layers.get_all_param_values([l_decoder_f]),
                 open('models/100_mse_timit_f_{}_{}_{}_direct'.format(date, NUM_UNITS_ENC, index_timit), 'wb'))
    if tpe is 1:
        if normalize is 1:
            savemat('results/100_one_minus_timit_{}_N_direct.mat'.format(index_timit), {'out_out_m': out_out_m,
                                                                     'mmm': mmm})
        else:
            savemat('results/100_one_minus_timit_{}_direct.mat'.format(index_timit), {'out_out_m': out_out_m})
        pkl.dump(lasagne.layers.get_all_param_values([l_decoder_m]),
                 open('models/100_one_minus_timit_m_{}_{}_{}_direct'.format(date, NUM_UNITS_ENC, index_timit), 'wb'))
        pkl.dump(lasagne.layers.get_all_param_values([l_decoder_f]),
                 open('models/100_one_minus_timit_f_{}_{}_{}_direct'.format(date, NUM_UNITS_ENC, index_timit), 'wb'))
    if tpe is 2:
        if normalize is 1:
            savemat('results/100_force_SIR_timit_{}_N_direct.mat'.format(index_timit), {'out_out_m': out_out_m,
                                                               'out_out_f': out_out_f,
                                                               'mmm': mmm})
        else:
            savemat('results/100_force_SIR_timit_{}_direct.mat'.format(index_timit), {'out_out_m': out_out_m, 'out_out_f': out_out_f})
        pkl.dump(lasagne.layers.get_all_param_values([l_decoder_m]),
                 open('models/100_force_SIR_timit_m_{}_{}_{}_direct'.format(date, NUM_UNITS_ENC, index_timit), 'wb'))
        pkl.dump(lasagne.layers.get_all_param_values([l_decoder_f]),
                 open('models/100_force_SIR_timit_f_{}_{}_{}_direct'.format(date, NUM_UNITS_ENC, index_timit), 'wb'))
