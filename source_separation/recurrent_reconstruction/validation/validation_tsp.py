...
if __name__ == "__main__":
    ...
    fs = 16
    train_m = loadmat('data/TSP_{}.mat'.format(fs, index_timit))['PWRa']
    train_f = loadmat('data/TSP_{}.mat'.format(fs, index_timit))['PWRb']
    train_x = loadmat('data/TSP_{}.mat'.format(fs, index_timit))['PWR']
    test_m = loadmat('data/TSP_{}.mat'.format(fs, index_timit))['PWRatest']
    test_f = loadmat('data/TSP_{}.mat'.format(fs, index_timit))['PWRbtest']
    test_x = loadmat('data/TSP_{}.mat'.format(fs, index_timit))['PWRtest']
    ...
    if tpe is 0:
        savemat('results/tsp/special_TSP_{}.mat'.format(index_timit), {'out_out_m': out_out_m, 'out_out_f': out_out_f})

    if tpe is 1:
        savemat('results/tsp/one_minus_TSP_{}.mat'.format(index_timit), {'out_out_m': out_out_m})

    if tpe is 2:
        savemat('results/tsp/force_SIR_TSP_{}.mat'.format(index_timit), {'out_out_m': out_out_m, 'out_out_f': out_out_f})
