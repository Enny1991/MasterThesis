...
savemat('RR_2models_PCA24_direct.mat', {'out_out_m': out_out_m,
                                        'out_out_f': out_out_f,
...
pkl.dump(lasagne.layers.get_all_param_values([l_decoder_m]),
         open('RR_2models_PCA24_direct_m'.format(date, NUM_UNITS_ENC), 'wb'))
pkl.dump(lasagne.layers.get_all_param_values([l_decoder_f]),
         open('RR_2models_PCA24_direct_f'.format(date, NUM_UNITS_ENC), 'wb'))
