...
if __name__ == "__main__":
    ...
    tpe = int(sys.argv[1])  # 0 mse / 1 one_minus / 2 force_SIR
    ...
    train_m = loadmat('data/audio_book.mat')['PWRa']
    train_f = loadmat('data/audio_book.mat')['PWRb']
    train_x = loadmat('data/audio_book.mat')['PWR']
    test_m = loadmat('data/audio_book.mat')['PWRatest']
    test_f = loadmat('data/audio_book.mat')['PWRbtest']
    test_x = loadmat('data/audio_book.mat')['PWRtest']
    ...
    if tpe is 0:    
        savemat('results/sigmoid/special_big_audiobook.mat'.format(index_timit), {'out_out_m': out_out_m, 'out_out_f': out_out_f})
    ...
    if tpe is 1:
        savemat('results/sigmoid/one_minus_big_audio_book.mat'.format(index_timit), {'out_out_m': out_out_m})
        # pkl.dump(lasagne.layers.get_all_param_values([l_out_m]),
    ...
    if tpe is 2:
        savemat('results/sigmoid/force_SIR_big_audio_book.mat'.format(index_timit), {'out_out_m': out_out_m, 'out_out_f': out_out_f,'debug_train_m':debug_train_m,'debug_test_m':debug_test_m,'debug_test_f':debug_test_f,'debug_train_f':debug_train_f})
        # pkl.dump(lasagne.layers.get_all_param_values([l_out_m]),
