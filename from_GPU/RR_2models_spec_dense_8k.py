...
all_grads_target_m = lasagne.updates.total_norm_constraint(all_grads_target_m, 50)
...
all_grads_target_f = lasagne.updates.total_norm_constraint(all_grads_target_f, 50)
