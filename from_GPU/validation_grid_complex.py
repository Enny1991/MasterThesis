...
if __name__ == "__main__":
    ...
    train_m = loadmat('data/stacked_GRID_{}.mat'.format(index_timit))['SPTa']
    train_f = loadmat('data/stacked_GRID_{}.mat'.format(index_timit))['SPTb']
    train_x = loadmat('data/stacked_GRID_{}.mat'.format(index_timit))['SPT']
    test_m = loadmat('data/stacked_GRID_{}.mat'.format(index_timit))['SPTatest']
    test_f = loadmat('data/stacked_GRID_{}.mat'.format(index_timit))['SPTbtest']
    test_x = loadmat('data/stacked_GRID_{}.mat'.format(index_timit))['SPTtest']
