...
if __name__ == "__main__":
    ...
    if tpe is 0:
        if normalize is 1:
            ...
            savemat('results/sigmoid/mse_GRID_{}.mat'.format(index_timit), {'out_out_m': out_out_m, 'out_out_f': out_out_f})
    ...
    if tpe is 1:
        if normalize is 1:
            ...
            savemat('results/sigmoid/800_one_minus_GRID_{}.mat'.format(index_timit), {'out_out_m': out_out_m})
        pkl.dump(lasagne.layers.get_all_param_values([l_out_m]),
    ...
    if tpe is 2:
        if normalize is 1:
            ...
            savemat('results/sigmoid/force_SIR_GRID_{}.mat'.format(index_timit), {'out_out_m': out_out_m, 'out_out_f': out_out_f})
        pkl.dump(lasagne.layers.get_all_param_values([l_out_m]),
