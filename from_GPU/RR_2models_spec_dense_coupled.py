...
data_m = loadmat('m_f_book_SPEC.mat')['hunchback']
data_f = loadmat('m_f_book_SPEC.mat')['screw']
#mask_m = loadmat('m_f_book_SPEC.mat')['s_mask_m']
#mask_f = loadmat('m_f_book_SPEC.mat')['s_mask_f']
data_mix = loadmat('m_f_book_SPEC.mat')['hunchback_screw']
