...
l_dec_1 = LSTMAttentionDecodeFeedbackLayer(l_enc_1,
                                        num_units=NUM_UNITS_DEC,
                                        aln_num_units=20,
                                        n_decodesteps=MAX_DIGITS+1,
                                        name='LSTMDecoder')

l_concat = lasagne.layers.ConcatLayer([l_enc_2, l_dec_1], axis=2)

l_dec_2 = LSTMAttentionDecodeFeedbackLayer(l_concat,
                                        num_units=NUM_UNITS_DEC,
                                        aln_num_units=20,
                                        n_decodesteps=MAX_DIGITS+1,
                                        name='LSTMDecoder')
